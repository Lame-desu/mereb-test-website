              ...
              <div className="mb-12 flex flex-col items-center">
                ...
                <div className="mt-6">
                  ...
                  <div className="flex items-center justify-center space-x-3">
                    ...
                    {website && (
                      <a href={website} target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-blue-50 text-blue-600">
                        <svg className="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
